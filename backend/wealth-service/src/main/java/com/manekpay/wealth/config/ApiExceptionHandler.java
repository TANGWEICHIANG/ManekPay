package com.manekpay.wealth.config;

import com.manekpay.wealth.dto.ErrorResponse;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    // Backstop for the narrow two-concurrent-buys-of-the-same-asset race described in
    // TradeService - turns the loser's raw unique-constraint failure into a sane response
    // instead of an opaque 500, same pattern as ledger-service's own idempotency-key backstop.
